...
static const char __pyx_k_export_project_piqasso_Experime[] = "/export/project/piqasso/Experiments/NegationAndSpeculation/ELN/deepnl_william/deepnl/hpca.pyx";
...
static PyObject *__pyx_pw_6deepnl_4hpca_1cooccurrences(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("cooccurrences (wrapper)", 0);
  {
    ...
    __pyx_v_corpus = __Pyx_PyObject_AsString(values[0]); if (unlikely((!__pyx_v_corpus) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_vocabFile = __Pyx_PyObject_AsString(values[1]); if (unlikely((!__pyx_v_vocabFile) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
 ...
 *     Compute the cooccurrence matrix on a corpus of sentences, using as
 */
  __pyx_tuple__8 = PyTuple_Pack(4, __pyx_n_s_corpus, __pyx_n_s_vocabFile, __pyx_n_s_top, __pyx_n_s_window); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(4, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_export_project_piqasso_Experime, __pyx_n_s_cooccurrences, 39, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
